...
const (
	localRuleNumber  int    = 1
	remoteRuleNumber int    = 2
	localQueue       uint16 = 1
	remoteQueue      uint16 = 2
)
...
func inject(
	...
	// Create go funcs
	go newNFQueueToChan(ctx, localQueue, localChan)
	go newNFQueueToChan(ctx, remoteQueue, remoteChan)
